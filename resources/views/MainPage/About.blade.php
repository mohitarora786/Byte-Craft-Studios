<section class="about-two">
    <div class="about-two_pattern-two" style="background-image: url({{ asset('images/background/pattern-13.webp') }})"></div>
    <div class="auto-container">
        <div id="row-clearfix" class="row clearfix">
            <!-- Content Column -->
            <div class="about-two_image-column col-lg-6 col-md-12 col-sm-12">
                <div class="about-two_pattern-one" style="background-image: url({{ asset('images/background/pattern-12.webp') }})"></div>
                <div class="about-two_image">
                    <img src="{{ asset('images/resource/about-2.webp') }}" alt="" />
                    <!-- About One Detail -->
                    ...
                    <div class="about-two_feature">
                        <div class="row clearfix">
                            ...
                            <div class="about-two_block col-lg-6 col-md-6 col-sm-6">
                                <div class="about-two_block-inner">
                                    <span class="about-two_block-icon">
                                        <img src="{{ asset('images/icons/about-1.webp') }}" alt="" />
                                    </span>
                            ...
                            <div class="about-two_block col-lg-6 col-md-6 col-sm-6">
                                <div class="about-two_block-inner">
                                    <span class="about-two_block-icon">
                                        <img src="{{ asset('images/icons/about-2.webp') }}" alt="" />
                                    </span>
                                    <h6 class="about-two_block-heading">
                                        Technical <br />
                                        Support
