                    ...
                    <div class="sidebar-widget category-widget">
                        <div class="drop-down mobile-drop">
                            ...
                            <div id="toc" class="toc-body">
                                <ul class="toc-list">
                                    <li class="toc-item">
                                        <a class="toc-link" href="{{ url('data.analytics') }}">Data Analytics and Business Intelligence</a>
                                    </li>
                                    <li class="toc-item">
                                        <a class="toc-link" href="{{ url('data.management') }}">Data Management</a>
                                    </li>
                                    <li class="toc-item">
                                        <a class="toc-link" href="{{ url('ai.machine.learning') }}">Artificial Intelligence and Machine Learning</a>
                                    </li>
                                    <li class="toc-item">
                                        <a class="toc-link" href="{{ url('data.science.consulting') }}">Data Science and AI Consulting</a>
                                    </li>
                                    <li class="toc-item">
                                        <a class="toc-link" href="{{ url('big.data.solutions') }}">Data Lakes and Big Data Solutions</a>
                                    </li>
                                    <li class="toc-item">
                                        <a class="toc-link" href="{{ url('edge.computing') }}">Edge Computing Solutions</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="inner-box">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="feature-two col-lg-6 col-md-6 col-sm-12">
                                <div class="feature-two_inner">
                                    <div class="feature-two_content">
                                        <span class="feature-two_icon"><img src="{{ asset('images/icons/feature-6.webp') }}" alt="" /></span>
                            ...
                            <div class="feature-two col-lg-6 col-md-6 col-sm-12">
                                <div class="feature-two_inner">
                                    <div class="feature-two_content">
                                        <span class="feature-two_icon"><img src="{{ asset('images/icons/feature-7.webp') }}" alt="" /></span>
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="column col-lg-6 col-md-6 col-sm-12">
                                ...
                                <p>
                                    By initiating your project with Fingent, you get a dedicated and skilled team backing you up round-the-clock. All our processes are customer-oriented, designed to reduce the cost of business operations.
                                </p>
                            </div>
                        </div>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="feature-three col-lg-4 col-md-4 col-sm-6">
                                    <div class="feature-three_inner">
                                        <span class="feature-three_icon"><img src="{{ asset('images/icons/service-35.webp') }}" alt="" /></span>
                                        Best quality <br />
                                        support
                                    </div>
                                </div>
                                ...
                                <div class="feature-three col-lg-4 col-md-4 col-sm-6">
                                    <div class="feature-three_inner">
                                        <span class="feature-three_icon"><img src="{{ asset('images/icons/service-36.webp') }}" alt="" /></span>
                                        Best quality <br />
                                        support
                                    </div>
                                </div>
                                ...
                                <div class="feature-three col-lg-4 col-md-4 col-sm-6">
                                    <div class="feature-three_inner">
                                        <span class="feature-three_icon"><img src="{{ asset('images/icons/service-37.webp') }}" alt="" /></span>
                                        Best quality <br />
                                        support
                                    </div>
                                </div>
